...
export const ACTION_TYPES = {
  ...
  PARTIAL_UPDATE_MEMBER: 'member/PARTIAL_UPDATE_MEMBER',
...
export default (state: MemberState = initialState, action): MemberState => {
  switch (action.type) {
    ...
    case REQUEST(ACTION_TYPES.PARTIAL_UPDATE_MEMBER):
      return {
        ...state,
        errorMessage: null,
        updateSuccess: false,
    ...
    case FAILURE(ACTION_TYPES.PARTIAL_UPDATE_MEMBER):
    ...
    case SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_MEMBER):
      return {
        ...state,
        updating: false,
        updateSuccess: true,
...
export const partialUpdate: ICrudPutAction<IMember> = entity => async dispatch => {
  const result = await dispatch({
    type: ACTION_TYPES.PARTIAL_UPDATE_MEMBER,

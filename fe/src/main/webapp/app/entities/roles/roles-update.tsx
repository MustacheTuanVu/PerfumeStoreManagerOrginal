...
export const RolesUpdate = (props: IRolesUpdateProps) => {
  const [isNew] = useState(!props.match.params || !props.match.params.id);

  const { rolesEntity, loading, updating } = props;
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="perfumeStoreManagerApp.roles.home.createOrEditLabel" data-cy="RolesCreateUpdateHeading">
            <Translate contentKey="perfumeStoreManagerApp.roles.home.createOrEditLabel">Create or edit a Roles</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : rolesEntity} onSubmit={saveEntity}>
              {!isNew ? (
                <AvGroup>
                  <Label for="roles-id">
              ...
              <AvGroup>
                <Label id="roleIDLabel" for="roles-roleID">
                  <Translate contentKey="perfumeStoreManagerApp.roles.roleID">Role ID</Translate>
                </Label>
                <AvField id="roles-roleID" data-cy="roleID" type="text" name="roleID" />
              </AvGroup>
              <AvGroup>
                <Label id="roleNameLabel" for="roles-roleName">
                  <Translate contentKey="perfumeStoreManagerApp.roles.roleName">Role Name</Translate>
                </Label>
                <AvField id="roles-roleName" data-cy="roleName" type="text" name="roleName" />
              </AvGroup>
...
export default connect(mapStateToProps, mapDispatchToProps)(RolesUpdate);

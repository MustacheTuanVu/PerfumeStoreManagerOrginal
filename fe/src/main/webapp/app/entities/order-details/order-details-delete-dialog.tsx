...
export const OrderDetailsDeleteDialog = (props: IOrderDetailsDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="perfumeStoreManagerApp.orderDetails.delete.question">
        <Translate contentKey="perfumeStoreManagerApp.orderDetails.delete.question" interpolate={{ id: orderDetailsEntity.id }}>

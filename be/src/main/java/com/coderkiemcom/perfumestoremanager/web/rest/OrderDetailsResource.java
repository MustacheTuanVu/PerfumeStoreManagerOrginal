...
import com.coderkiemcom.perfumestoremanager.service.OrderDetailsQueryService;
...
/**
 * REST controller for managing {@link com.coderkiemcom.perfumestoremanager.domain.OrderDetails}.
 */
@RestController
@RequestMapping("/api")
public class OrderDetailsResource {
    ...
    public ResponseEntity<List<OrderDetailsDTO>> getAllOrderDetails(OrderDetailsCriteria criteria, Pageable pageable) {
